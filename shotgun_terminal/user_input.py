...
class UserInputCollector:
    ...
    def collect_user_task(self) -> str:
        ...
        console.print(
            "[dim]You can describe what you want to do, what needs to be fixed, or what feature to implement[/dim]"
        )
    ...
    def collect_custom_rules(self) -> str:
        ...
        console.print(
            "[dim]Each line will be a rule. Type 'END' on a new line to finish[/dim]"
        )
    ...
    def _get_multiline_terminal_input(self, prompt_text: str) -> str:
        ...
        console.print(
            "[dim]Type your content. Type 'END' on a new line to finish[/dim]"
        )
